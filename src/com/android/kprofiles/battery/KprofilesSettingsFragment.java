...
public class KprofilesSettingsFragment extends PreferenceFragment
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        kProfilesEnabledPreference.setEnabled(isMainSwitchEnabled);
        ...
        if (Utils.isAutoSupported(getContext())) {
            kProfilesAutoPreference.setEnabled(isMainSwitchEnabled);
        ...
        if (isModesSupported) {
            kProfilesModesPreference.setEnabled(isMainSwitchEnabled);
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (key.equals(getString(R.string.pref_key_enabled))) {
            ...
            Utils.writeToAutoNode(
                    getContext(), prefs.getBoolean(getString(R.string.pref_key_auto), false));
        } else if (key.equals(getString(R.string.pref_key_modes))) {
            final String value =
                    prefs.getString(
                            getString(R.string.pref_key_modes),
                            getString(R.string.kprofiles_modes_none));
    ...
    private void updateValues() {
        ...
        if (FileUtils.fileExists(getString(R.string.kprofiles_auto_node))) {
            final boolean enabled = prefs.getBoolean(getString(R.string.pref_key_auto), false);
            kProfilesAutoPreference.setChecked(enabled);
            if (!isMainSwitchEnabled) {
                Utils.writeToAutoNode(getContext(), false);
            } else {
                Utils.writeToAutoNode(getContext(), enabled);
            }
        }
        ...
        if (Utils.isModesSupported(getContext())) {
            ...
            if (!isMainSwitchEnabled) {
                Utils.writeToModesNode(getContext(), getString(R.string.kprofiles_modes_none));
            } else {
                Utils.writeToModesNode(getContext(), value);
            }
            updateTitle(value);
